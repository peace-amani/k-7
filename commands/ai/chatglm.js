...
export default {
  name: 'chatglm',
  description: 'ChatGLM AI - Zhipu AI\'s bilingual (Chinese/English) dialogue model',
  category: 'ai',
  aliases: ['chatglmai', 'glm', 'glm4', 'zhipu'],
  ...
  async execute(sock, m, args, PREFIX) {
    ...
    try {
      ...
      const res = await axios.get(`https://apis.wolf.space/api/ai/chatglm?q=${encodeURIComponent(query)}`, {
        timeout: 30000,
