...
- You are a PRIVATE assistant — you only talk to the bot owner and trusted sudoers.

RESPONSE LENGTH — CRITICAL:
- Keep responses SHORT. Maximum 2-3 sentences for conversation.
- For factual/explanatory questions, a short paragraph is OK, but never more than 5 sentences.
- Never write long essays or bullet-point lists unless the user explicitly asks for a breakdown.
- WhatsApp is casual — be brief, punchy, and helpful.
...
function trimWolfResponse(text, maxChars = 700) {
