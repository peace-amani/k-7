...
// Config is stored in data/cpanel_config.json (not the SQLite DB so it is easy to inspect)
const CONFIG_PATH = path.join(__dirname, '..', 'data', 'cpanel_config.json');
...
export function loadConfig() {
    try {
        if (fs.existsSync(CONFIG_PATH)) {
            ...
            // Deep merge so new default keys appear even on old config files
            return {
                ...DEFAULT_CONFIG,
                ...saved,
